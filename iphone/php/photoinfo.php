<body id="kitindex">
	...
	<div id="header">
		<h1>Photo info</h1>
		<a href="javascript:window.location.href='photos.php'" id="backButton" class="nav">Back</a>
...
;
 ...
 print '<ul class="data">';
 print "<li>";
 print "<div align='center'> <img src='../$username/thumbnails/$filename' alt='$filename' /> </div>"; 
 print "</li>";
 print "</ul>";
 Print '<h1>Name</h1>';
 print '<ul class="data">';
