<body id="kitindex">
	...
	<div id="header">
		<h1>File info</h1>
		<a href="media.php" id="backButton" class="nav">Back</a>
		<a href="logout.php" class="nav Action">logout</a>
	</div>
	<br/>
...
;
 ...
 Print '<div align="center"> <video src="'.$info['url'].'" controls preload="auto" autobuffer></video> </div>';
 Print '<h1>Name</h1>';
 print '<ul class="data">';
 print "<li>";
 print $filename; 
